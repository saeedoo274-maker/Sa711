...
// اللغة والأنظمة والثيم والسجلات والترحيب والتحقق والإشعارات والاستئنافات
// صار تحكمها كله من /لوحة ← الأنظمة والإعدادات، فبقي هنا ما يحتاج مدخلات حرة.
const AUTO = {
...
module.exports = [
  {
    ...
    description: "معالج الإعداد، منشئ الصلاحيات، الأتمتة، مفاتيح API، والنسخ الاحتياطي. بقية الإعدادات من /لوحة ← الأنظمة والإعدادات.",
    usage: "/اعداد setup | /اعداد permissions action:deny target:system:games role:@عضو",
    arguments: [
      { name: "setup", required: false, description: "معالج الإعداد خطوة بخطوة" },
      { name: "permissions", required: false, description: "منشئ الصلاحيات" },
      { name: "automation", required: false, description: "منشئ الأتمتة" },
      { name: "api", required: false, description: "مفاتيح REST API" },
      { name: "backup", required: false, description: "نسخ السيرفر والاستعادة" }
    ],
    examples: ["/اعداد setup", "/اعداد permissions action:deny target:system:games role:@عضو", "/اعداد backup action:restore id:3"],
    category: "settings",
    slashOnly: true,
    cooldown: 2000,
